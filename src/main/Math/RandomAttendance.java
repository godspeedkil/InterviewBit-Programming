...
public class RandomAttendance {
    ...
    /**
     * Naive approach utilizing merge sort. As expected, heap runs out of
     * memory when A is too big.
     **/
    public static ArrayList<Integer> solveNaive(int A, ArrayList<Integer> B) {
        ...
        System.out.println(names[113]);

        ArrayList<Integer> attendance = new ArrayList<>();
        for(int i=0; i<B.size(); i++) {
            attendance.add(Integer.parseInt(names[B.get(i)-1]));
        }
    ...
    public static void main(String[] args) {
        System.out.println(solveNaive(500, new ArrayList<>(Arrays.asList(1, 3, 5,
                500))).toString());
    }
}
